...
input_parameters read_arguments(int argc, char* const argv[])
{
    ...
    rare.add_options()
        ...
        ("initial_weights", po::value<string>()->default_value(""), "Initial weights for global free rate model (will be multiplied by the distribution mean)")
        ("initial_values", po::value<string>()->default_value(""), "Initial values for global free rate model")
    ...
    maybe_set(vm, "initial_values", my_input_parameters.initial_values);
